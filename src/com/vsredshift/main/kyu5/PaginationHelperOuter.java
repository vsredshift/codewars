...
//                    itemCount() / itemsPerPage + 1;
    ...
    public static class PaginationHelperBestPractice<I> {
        private final int itemCount;
        private final int itemsPerPage;
        private final int pageCount;

        public PaginationHelperBestPractice(final List<I> items, final int itemsPerPage) {
            this(items.size(), itemsPerPage);
        }

        public PaginationHelperBestPractice(final int itemCount, final int itemsPerPage) {
